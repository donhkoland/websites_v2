...
(() => {
  ...
  const PLACES = [
    { key:"estancia", n:"Estancia VIK", kind:"Retreat 01", country:"Uruguay",
      ...
      film:"assets/video/estancia.mp4",
    ...
    { key:"milano", n:"Galleria VIK", kind:"Retreat 04", country:"Italy",
      ...
      img:"assets/img/t/milano_galleria-w1600.jpg",
      film:"assets/video/milano.mp4",
    ...
    { key:"chile", n:"VIK Chile", kind:"Retreat 05", country:"Chile",
      ...
      img:"assets/img/t/bahia_bg-vina-vik-w1600.jpg",
      film:"assets/video/chile.mp4",
