...
(() => {
  ...
  const src = (rel, px) =>
    (window.VIK.derivative ? window.VIK.derivative(rel, px).src : A("assets/img/") + rel);
  const full = rel =>
    (rel.startsWith(window.VIK_BASE || "assets/") || rel.startsWith("assets/")
       || rel.startsWith("http")) ? rel : A("assets/img/") + rel;
