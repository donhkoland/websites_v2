...
(() => {
  ...
  const PTS = [
    { key:"bahia",    lat:-34.838119, lng:-54.648421, home:true, img:"assets/img/bahia/1_bv-0439-scaled.jpg",
      n:"Bahía VIK",   d:"Within the dunes on Playa Mansa",        tag:"Retreat 03", meta:"Design · social · wellness" },
    { key:"playa",    lat:-34.841981, lng:-54.640792, img:"assets/img/playa/80c9a60ef2cc735699a0e504cbfa54955f3113fe.jpeg",
      n:"Playa VIK",   d:"Above the point, facing the Atlantic",   tag:"Retreat 02", meta:"Architecture · art · privacy" },
    { key:"estancia", lat:-34.784209, lng:-54.697643, img:"assets/img/estancia/estancia-img_7582-min-1.jpg",
      n:"Estancia VIK",d:"Open countryside, horses and fire",      tag:"Retreat 01", meta:"40 min inland" },
    { key:"pavilion", lat:-34.838067, lng:-54.647965, img:"assets/img/bahia/cp-bahiavik-0549-scaled.jpg",
      n:"Pavilion VIK",d:"Oceanfront events and culture",          tag:"Venue",      meta:"Weddings · gatherings" },
    { key:"susana",   lat:-34.838267, lng:-54.647591, img:"assets/img/bahia/vik_food08.jpg",
      n:"La Susana",   d:"Beach dining, music and sunset",         tag:"Dining",     meta:"Playa Mansa" },
    { key:"faro",     lat:-34.84627, lng:-54.632782, img:"assets/img/map/faro.jpg",
      n:"José Ignacio Lighthouse", d:"The village landmark",       tag:"Landmark",   meta:"10 min · the village" },
    { key:"laguna",   lat:-34.802362, lng:-54.572086, img:"assets/img/map/garzon.jpg",
      n:"Laguna Garzón", d:"Nature and the ring bridge",           tag:"Nature",     meta:"30 min · the lagoon" },
    { key:"airport",  lat:-34.8551, lng:-55.0944, img:"assets/img/map/airport.jpg",
...
/* Selecting a property lands twice as close as it used to.
  ...
  const popupHTML = p => {
    ...
    return `<div class="pop-media" style="background-image:url('${p.img}')">${p.tag ? `<span class="pop-tag">${p.tag}</span>` : ""}</div>`
