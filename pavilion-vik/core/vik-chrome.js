...
(() => {
  ...
  <nav class="nav" id="mainNav" aria-label="Primary">
    ...
    <div class="nav-end">
      <a class="nav-link nav-book" href="${S.bookHref || BOOK}"${S.bookHref ? "" : ' target="_blank" rel="noopener"'}${S.bookLabel ? "" : ' data-i18n="cta.book"'}><span class="nb-long">${S.bookLabel || "Book Your Stay"}</span><span class="nb-short">${S.bookShort || (S.bookLabel || "Book Your Stay").split(" ")[0]}</span></a>
